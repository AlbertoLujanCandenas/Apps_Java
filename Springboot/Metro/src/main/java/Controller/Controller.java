...
import Model.Linea;
import Repositorio.LineaRepositorio;
	...
	public class Controller {
	    @Autowired
	    LineaRepositorio lineaRepository;

	    // Welcome de nuestra api por ejemplo podríamos poner aquí
	    @RequestMapping(value = "/", method = RequestMethod.GET, produces = "text/html")
	    public String get() {
	   	 String cadena = "<h1 style='text-align: center; background-color: #0000c0; color: #C0C0FF;'>Welcome to Metro Api with SpringBoot - PacoPul</h1>";
